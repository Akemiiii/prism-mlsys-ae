...
def main(args):
    ...
    output_throughput = num_output_tokens / total_latency  
    ...
    print(
        f"#questions: {len(questions)}, Throughput: {output_throughput:.3f} token/s, Acceptance length: {accept_length:.3f}, Temperature: {args.temperature}"
    )
